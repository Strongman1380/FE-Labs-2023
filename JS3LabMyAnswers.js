 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
let reverseAlphabetArray = alphabetArray.reverse();
console.log(reverseAlphabetArray.join(''));
let reverseAlphabetString = reverseAlphabetArray.join('');
console.log(reverseAlphabetString);
 ...
 * ↓ YOUR CODE HERE ↓ */
var myTodoList = [];
myTodoList.push("Buy groceries", "Walk the dog", "Complete homework");
console.log(myTodoList);
myTodoList.splice(1, 1);
console.log(myTodoList);
var yourTodoList = ["Clean the house", "Do laundry"];
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
function isEven(x) {true if (x % 2 === 0) {return true} else {return false}}
...
function addingMachine(x) {addingMachine = 0; for (let i = 0; i < x.length; i++) {addingMachine += x[i]} return addingMachine}
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
function reverse(x) {if (typeof x === 'boolean') {return !x} else if (typeof x === 'number') {return parseFloat(x.toString().split('').reverse().join(''))} else if (typeof x === 'string') {return x.split('').reverse().join('')} else if (Array.isArray(x)) {return x.reverse().map(reverse)} else {return false}}
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
function removeElements(array) {while (array.length > 0) {array.pop()} return array}
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
function whichArrayIsLonger(array1, array2) {if (array1.length > array2.length) {return array1} else if (array1.length < array2.length) {return array2} else {return false}}
